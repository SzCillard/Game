...
class MCTSAgent:
    ...
    def __init__(
        self,
        brain: NeatNetwork,
        dfs_action_sets_limit: int = 500,  # DFS limit for sequence generation
        dfs_branching_limit: int = 10,  # max actions per DFS node
        max_root_children: int = 8,  # how many root moves to keep
        iterations: int = 300,  # MCTS iterations per AI move
